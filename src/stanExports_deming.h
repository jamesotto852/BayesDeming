...
namespace model_deming_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_deming");
    reader.add_event(65, 63, "end", "model_deming");
    return reader;
}
#include <stan_meta_header.hpp>
class model_deming
  : public stan::model::model_base_crtp<model_deming> {
private:
        int Nx;
        int Ny;
        int K;
        ...
        double beta_mean;
public:
    model_deming(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_deming_namespace::model_deming";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_deming_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_deming_namespace::model_deming stan_model;
#ifndef USING_R
