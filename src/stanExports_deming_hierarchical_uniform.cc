...
#include "stanExports_deming_hierarchical_uniform.h"

RCPP_MODULE(stan_fit4deming_hierarchical_uniform_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_deming_hierarchical_uniform")
