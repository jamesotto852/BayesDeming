...
namespace model_deming_empirical_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_deming_empirical");
    reader.add_event(82, 80, "end", "model_deming_empirical");
    return reader;
}
#include <stan_meta_header.hpp>
class model_deming_empirical
  : public stan::model::model_base_crtp<model_deming_empirical> {
private:
        int Nx;
        int Ny;
        int K;
        ...
        int pos_transform;
public:
    model_deming_empirical(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_deming_empirical_namespace::model_deming_empirical";
        ...
        try {
            ...
            pos_transform = int(0);
            stan::math::fill(pos_transform, std::numeric_limits<int>::min());
            // execute transformed data statements
            current_statement_begin__ = 34;
            stan::math::assign(pos_transform, 1);
            current_statement_begin__ = 35;
            for (int k = 1; k <= K; ++k) {
                current_statement_begin__ = 36;
                stan::model::assign(theta, 
                            stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()), 
                            mean(segment(X, pos_transform, get_base1(Jx, k, "Jx", 1))), 
                            "assigning variable theta");
                current_statement_begin__ = 37;
                stan::math::assign(pos_transform, (pos_transform + get_base1(Jx, k, "Jx", 1)));
            }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            int pos_model(0);
            (void) pos_model;  // dummy to suppress unused var warning
            stan::math::fill(pos_model, std::numeric_limits<int>::min());
            ...
            stan::math::assign(pos_model, 1);
            current_statement_begin__ = 68;
            for (int k = 1; k <= K; ++k) {
                current_statement_begin__ = 69;
                lp_accum__.add(normal_log<propto__>(segment(X, pos_model, get_base1(Jx, k, "Jx", 1)), get_base1(theta, k, "theta", 1), sigma_x));
                current_statement_begin__ = 70;
                stan::math::assign(pos_model, (pos_model + get_base1(Jx, k, "Jx", 1)));
            }
            ...
            for (int k = 1; k <= K; ++k) {
                ...
                lp_accum__.add(normal_log<propto__>(segment(Y, pos_model, get_base1(Jy, k, "Jy", 1)), get_base1(nu, k, "nu", 1), sigma_y));
                current_statement_begin__ = 77;
                stan::math::assign(pos_model, (pos_model + get_base1(Jy, k, "Jy", 1)));
            }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_deming_empirical_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_deming_empirical_namespace::model_deming_empirical stan_model;
#ifndef USING_R
