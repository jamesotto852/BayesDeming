...
namespace model_deming_uniform_power_beta_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_deming_uniform_power_beta");
    reader.add_event(97, 95, "end", "model_deming_uniform_power_beta");
    return reader;
}
#include <stan_meta_header.hpp>
class model_deming_uniform_power_beta
  : public stan::model::model_base_crtp<model_deming_uniform_power_beta> {
private:
        int Nx;
        int Ny;
        int K;
        ...
        vector_d z_demeaned;
public:
    model_deming_uniform_power_beta(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_deming_uniform_power_beta_namespace::model_deming_uniform_power_beta";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "power_a", "double", context__.to_vec());
            power_a = double(0);
            vals_r__ = context__.vals_r("power_a");
            pos__ = 0;
            power_a = vals_r__[pos__++];
            check_greater_or_equal(function__, "power_a", power_a, 0);
            current_statement_begin__ = 29;
            context__.validate_dims("data initialization", "power_b", "double", context__.to_vec());
            power_b = double(0);
            vals_r__ = context__.vals_r("power_b");
            pos__ = 0;
            power_b = vals_r__[pos__++];
            check_greater_or_equal(function__, "power_b", power_b, 0);
    ...
    ~model_deming_uniform_power_beta() { }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(beta_log<propto__>(power, power_a, power_b));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_deming_uniform_power_beta_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_deming_uniform_power_beta";
    }
...
typedef model_deming_uniform_power_beta_namespace::model_deming_uniform_power_beta stan_model;
#ifndef USING_R
