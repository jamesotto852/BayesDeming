...
#include "stanExports_deming_flat_power_normal.h"

RCPP_MODULE(stan_fit4deming_flat_power_normal_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_deming_flat_power_normal")
