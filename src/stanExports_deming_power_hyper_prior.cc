...
#include "stanExports_deming_power_hyper_prior.h"

RCPP_MODULE(stan_fit4deming_power_hyper_prior_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_deming_power_hyper_prior")
