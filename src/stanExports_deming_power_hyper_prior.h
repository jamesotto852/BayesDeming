...
namespace model_deming_power_hyper_prior_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_deming_power_hyper_prior");
    reader.add_event(90, 88, "end", "model_deming_power_hyper_prior");
    return reader;
}
#include <stan_meta_header.hpp>
class model_deming_power_hyper_prior
  : public stan::model::model_base_crtp<model_deming_power_hyper_prior> {
private:
        int Nx;
        int Ny;
        int K;
        ...
        vector_d z_demeaned;
public:
    model_deming_power_hyper_prior(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_deming_power_hyper_prior_namespace::model_deming_power_hyper_prior";
    ...
    ~model_deming_power_hyper_prior() { }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_deming_power_hyper_prior_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_deming_power_hyper_prior";
    }
...
typedef model_deming_power_hyper_prior_namespace::model_deming_power_hyper_prior stan_model;
#ifndef USING_R
