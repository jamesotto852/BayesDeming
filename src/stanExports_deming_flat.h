...
namespace model_deming_flat_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_deming_flat");
    reader.add_event(70, 68, "end", "model_deming_flat");
    return reader;
}
#include <stan_meta_header.hpp>
class model_deming_flat
  : public stan::model::model_base_crtp<model_deming_flat> {
private:
        int Nx;
        int Ny;
        int K;
        ...
        double beta_mean;
public:
    model_deming_flat(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_deming_flat_namespace::model_deming_flat";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_deming_flat_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_deming_flat_namespace::model_deming_flat stan_model;
#ifndef USING_R
