...
#include "stanExports_deming_uniform.h"

RCPP_MODULE(stan_fit4deming_uniform_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_deming_uniform")
