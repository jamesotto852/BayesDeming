...
namespace model_deming_normal_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_deming_normal");
    reader.add_event(74, 72, "end", "model_deming_normal");
    return reader;
}
#include <stan_meta_header.hpp>
class model_deming_normal
  : public stan::model::model_base_crtp<model_deming_normal> {
private:
        int Nx;
        int Ny;
        int K;
        ...
        double theta_sd;
public:
    model_deming_normal(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_deming_normal_namespace::model_deming_normal";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "theta_mean", "double", context__.to_vec());
            theta_mean = double(0);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(theta, theta_mean, theta_sd));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_deming_normal_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_deming_normal_namespace::model_deming_normal stan_model;
#ifndef USING_R
