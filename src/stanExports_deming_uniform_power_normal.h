...
namespace model_deming_uniform_power_normal_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_deming_uniform_power_normal");
    reader.add_event(97, 95, "end", "model_deming_uniform_power_normal");
    return reader;
}
#include <stan_meta_header.hpp>
class model_deming_uniform_power_normal
  : public stan::model::model_base_crtp<model_deming_uniform_power_normal> {
private:
        int Nx;
        int Ny;
        int K;
        ...
        vector_d z_demeaned;
public:
    model_deming_uniform_power_normal(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_deming_uniform_power_normal_namespace::model_deming_uniform_power_normal";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "sigma_x_min", "double", context__.to_vec());
            sigma_x_min = double(0);
            vals_r__ = context__.vals_r("sigma_x_min");
            pos__ = 0;
            sigma_x_min = vals_r__[pos__++];
            check_greater_or_equal(function__, "sigma_x_min", sigma_x_min, 0);
            current_statement_begin__ = 19;
            context__.validate_dims("data initialization", "sigma_y_min", "double", context__.to_vec());
            sigma_y_min = double(0);
            vals_r__ = context__.vals_r("sigma_y_min");
            pos__ = 0;
            sigma_y_min = vals_r__[pos__++];
            check_greater_or_equal(function__, "sigma_y_min", sigma_y_min, 0);
            ...
            context__.validate_dims("data initialization", "power_mean", "double", context__.to_vec());
            power_mean = double(0);
            vals_r__ = context__.vals_r("power_mean");
            pos__ = 0;
            power_mean = vals_r__[pos__++];
            check_greater_or_equal(function__, "power_mean", power_mean, 0);
            check_less_or_equal(function__, "power_mean", power_mean, 1);
            current_statement_begin__ = 29;
            context__.validate_dims("data initialization", "power_sd", "double", context__.to_vec());
            power_sd = double(0);
            vals_r__ = context__.vals_r("power_sd");
            pos__ = 0;
            power_sd = vals_r__[pos__++];
            check_greater_or_equal(function__, "power_sd", power_sd, 0);
    ...
    ~model_deming_uniform_power_normal() { }
    void transform_inits(const stan::io::var_context& context__,
        ...
        try {
            writer__.scalar_lub_unconstrain(sigma_x_min, sigma_x_max, sigma_x);
        } catch (const std::exception& e) {
        ...
        try {
            writer__.scalar_lub_unconstrain(sigma_y_min, sigma_y_max, sigma_y);
        } catch (const std::exception& e) {
        ...
        current_statement_begin__ = 49;
        if (!(context__.contains_r("power")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable power missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("power");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "power", "double", context__.to_vec());
        double power(0);
        power = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0, 1, power);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable power: ") + e.what()), current_statement_begin__, prog_reader__());
        }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                sigma_x = in__.scalar_lub_constrain(sigma_x_min, sigma_x_max, lp__);
            else
                sigma_x = in__.scalar_lub_constrain(sigma_x_min, sigma_x_max);
            current_statement_begin__ = 47;
            local_scalar_t__ sigma_y;
            (void) sigma_y;  // dummy to suppress unused var warning
            if (jacobian__)
                sigma_y = in__.scalar_lub_constrain(sigma_y_min, sigma_y_max, lp__);
            else
                sigma_y = in__.scalar_lub_constrain(sigma_y_min, sigma_y_max);
            current_statement_begin__ = 49;
            local_scalar_t__ power;
            (void) power;  // dummy to suppress unused var warning
            if (jacobian__)
                power = in__.scalar_lub_constrain(0, 1, lp__);
            else
                power = in__.scalar_lub_constrain(0, 1);
            ...
            stan::math::assign(eta, add(alpha, multiply(beta, theta)));
            ...
            for (int k = 1; k <= K; ++k) {
                ...
                lp_accum__.add(normal_log<propto__>(segment(Y, pos, get_base1(Jy, k, "Jy", 1)), get_base1(eta, k, "eta", 1), sigma_y));
                current_statement_begin__ = 79;
                stan::math::assign(pos, (pos + get_base1(Jy, k, "Jy", 1)));
            }
            current_statement_begin__ = 84;
            lp_accum__.add(normal_log<propto__>(power, power_mean, power_sd));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_deming_uniform_power_normal_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double sigma_x = in__.scalar_lub_constrain(sigma_x_min, sigma_x_max);
        vars__.push_back(sigma_x);
        double sigma_y = in__.scalar_lub_constrain(sigma_y_min, sigma_y_max);
        vars__.push_back(sigma_y);
        double power = in__.scalar_lub_constrain(0, 1);
    ...
    std::string model_name() const {
        return "model_deming_uniform_power_normal";
    }
...
typedef model_deming_uniform_power_normal_namespace::model_deming_uniform_power_normal stan_model;
#ifndef USING_R
